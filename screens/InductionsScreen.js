...
function InductionsScreen({ navigation }) {
  ...
  // FlatList
  const Item = ({ title, videoLink, infoHere, hasCompleted, message }) => (
    <Pressable
      onPress={() =>
    ...
    >
      ...
      {hasCompleted && (
        <View>
          ...
          >
            You have completed this Induction
          </Text>
        </View>
      )}
    </Pressable>
...
export default InductionsScreen;
